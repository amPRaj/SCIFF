-- ⚡ QUICK START SCRIPT FOR SCIFF OTT PLATFORM
...
-- 🏫 Step 3: Create sample schools for testing
...
UNION ALL
SELECT 'DPS School: dps001 / school123'
UNION ALL
SELECT 'St. Xaviers: sxs002 / school123'
UNION ALL
...
BEGIN
    ...
    RAISE NOTICE '🏫 School Login: dps001 / school123 or sxs002 / school123';
