...
const NetflixHomePage: React.FC<NetflixHomePageProps> = ({ user, onLogout }) => {
                ...
                <div className="relative group">
                  ...
                  >
                    {categoryFilms.map((film) => (
                      <div
                        key={film.id}
                        className="relative flex-shrink-0 w-64 cursor-pointer group/film transform hover:scale-105 transition-all duration-300"
                      ...
                      >
                        ...
                        <div className="absolute top-0 left-0 w-80 bg-gray-900 rounded-lg shadow-2xl opacity-0 invisible group-hover/film:opacity-100 group-hover/film:visible transition-all duration-300 z-20 transform scale-0 group-hover/film:scale-100">
                          <div className="relative">
                            ...
                            <div className="p-4">
                              ...
                              <h3 className="text-white font-bold text-lg mb-2">{film.title}</h3>
                              ...
                              <div className="flex items-center space-x-4 text-sm text-gray-300 mb-3">
                                ...
                                {film.runtime_seconds && (
                                  <span>{Math.floor(film.runtime_seconds / 60)}m</span>
                                )}
                              </div>
